        ...
        <div className="mx-auto flex h-14 max-w-5xl items-center gap-2 px-4">
          ...
          <div className="ml-auto flex items-center gap-1 sm:ml-0">
            <Button
              ...
              className={`h-10 w-10 ${showFilters || hasFilters ? "text-primary" : ""}`}
              title="필터"
            >
              <FunnelSimple weight="light" className="h-5 w-5" />
              {hasFilters && (
        ...
        {showFilters && (
          <div className="border-t bg-muted/30 px-4 py-3">
            <div className="mx-auto flex max-w-5xl flex-wrap gap-3">
              <select
                className="h-10 w-full rounded-md border bg-background px-3 py-2 text-sm sm:w-auto"
